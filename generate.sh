...
rm -rf ./src/khulnasoft_api_client/v1 ./src/khulnasoft_api_client/v2 src/khulnasoft_api_client/{api_client.py,configuration.py,exceptions.py,model_utils.py,rest.py} examples/*
