...
project = "Khulnasoft API Client for Python"
...
html_theme_options = {
    ...
    "nav_title": "Khulnasoft API Client for Python",
    # Set the color and the accent color
    "color_primary": "deep-purple",
    "color_accent": "deep-purple",
    # Set the repo location to get a badge with stats
    "repo_url": "https://github.com/KhulnaSoft/khulnasoft-api-client-python/",
    "repo_name": "khulnasoft-api-client-python",
