    ...
    def pytest_terminal_summary(terminalreporter, exitstatus, config):
        ...
        if ci_pipeline_id and dd_service:
            ...
            terminalreporter.line(
                "* View test APM traces and detailed time reports on Khulnasoft (can take a few minutes to become available):"
            )
            terminalreporter.line(
                "* https://app.khulnasoft.com/ci/test-runs?query="
...
from khulnasoft_api_client import exceptions
from khulnasoft_api_client.api_client import ApiClient
from khulnasoft_api_client.configuration import Configuration
from khulnasoft_api_client.model_utils import OpenApiModel, file_type
...
def package_name(api_version):
    return "khulnasoft_api_client." + api_version
...
def build_given(version, operation):
    ...
    def wrapper(context, undo):
        ...
        package_name = f"khulnasoft_api_client.{version}"
