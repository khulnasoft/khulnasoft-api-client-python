...
from khulnasoft_api_client.api_client import AsyncApiClient
from khulnasoft_api_client.configuration import Configuration
from khulnasoft_api_client.exceptions import ForbiddenException
from khulnasoft_api_client.v1.api import dashboards_api, metrics_api
