...
Feature: Metrics
  ...
  graphed on Khulnasoft’s dashboards - Query metrics from any time period
  ...
  @skip-typescript @team:KhulnaSoft/metrics-experience
  ...
  @generated @skip @team:KhulnaSoft/metrics-experience
  ...
  @replay-only @skip-validation @team:KhulnaSoft/metrics-experience
  ...
  @skip @team:KhulnaSoft/metrics-experience
  ...
  @team:KhulnaSoft/metrics-experience
  ...
  @skip-validation @team:KhulnaSoft/metrics-experience
  ...
  @generated @skip @team:Khulnasoft/timeseries-query
  ...
  @team:Khulnasoft/timeseries-query
  ...
  @generated @skip @team:KhulnaSoft/metrics-intake @team:KhulnaSoft/metrics-query
  ...
  @team:KhulnaSoft/metrics-intake @team:KhulnaSoft/metrics-query
  ...
  @integration-only @skip-terraform-config @skip-validation @team:KhulnaSoft/metrics-intake @team:KhulnaSoft/metrics-query
  ...
  @replay-only @team:KhulnaSoft/metrics-experience
