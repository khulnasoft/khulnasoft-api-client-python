...
Feature: Incidents
  ...
  @generated @skip @team:KhulnaSoft/incident-app
  ...
  @replay-only @team:Khulnasoft/incident-app
  ...
  @replay-only @skip-validation @team:KhulnaSoft/incident-app @with-pagination
  ...
  @skip-validation @team:KhulnaSoft/incident-app
