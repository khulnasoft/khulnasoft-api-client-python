...
Feature: Teams
  View and manage teams within Khulnasoft.
  ...
  @generated @skip @team:KhulnaSoft/core-app
  ...
  @replay-only @skip-validation @team:KhulnaSoft/core-app @with-pagination
