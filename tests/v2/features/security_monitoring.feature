...
Feature: Security Monitoring
  ...
  @generated @skip @team:KhulnaSoft/k9-cloud-security-platform
  ...
  @replay-only @team:KhulnaSoft/k9-cloud-security-platform
  ...
  @team:KhulnaSoft/k9-cloud-security-platform
  ...
  @skip @team:KhulnaSoft/k9-cloud-security-platform
  ...
  @generated @skip @team:KhulnaSoft/cloud-security-posture-management
  ...
  @replay-only @team:KhulnaSoft/cloud-security-posture-management
  ...
  @replay-only @skip-validation @team:KhulnaSoft/k9-cloud-security-platform @with-pagination
  ...
  @generated @skip @team:KhulnaSoft/cloud-security-posture-management @with-pagination
  ...
  Scenario: Update a cloud configuration rule's details returns "OK" response
    ...
    And request contains "rule_id" parameter from "cloud_configuration_rule.id"
    And body with value {"name":"{{ unique }}_cloud_updated","isEnabled":false,"cases":[{"status":"info","notifications":[]}],"options":{"complianceRuleOptions":{"resourceType":"gcp_compute_disk", "regoRule":{"policy":"package khulnasoft\n\nimport data.khulnasoft.output as dd_output\n\nimport future.keywords.contains\nimport future.keywords.if\nimport future.keywords.in\n\nmilliseconds_in_a_day := ((1000 * 60) * 60) * 24\n\neval(iam_service_account_key) = \"skip\" if {\n\tiam_service_account_key.disabled\n} else = \"pass\" if {\n\t(iam_service_account_key.resource_seen_at / milliseconds_in_a_day) - (iam_service_account_key.valid_after_time / milliseconds_in_a_day) <= 90\n} else = \"fail\"\n\n# This part remains unchanged for all rules\nresults contains result if {\n\tsome resource in input.resources[input.main_resource_type]\n\tresult := dd_output.format(resource, eval(resource))\n}\n","resourceTypes":["gcp_compute_disk"]}}},"message":"ddd","tags":[],"complianceSignalOptions":{"userActivationStatus":false,"userGroupByFields":[]}}
    When the request is sent
    Then the response status is 200 OK
