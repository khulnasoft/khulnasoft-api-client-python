...
Feature: Sensitive Data Scanner
  ...
  @generated @skip @team:KhulnaSoft/logs-app @team:KhulnaSoft/logs-core
  ...
  @team:KhulnaSoft/logs-app @team:KhulnaSoft/logs-core
  ...
  @integration-only @team:KhulnaSoft/logs-app @team:KhulnaSoft/logs-core
  ...
  @replay-only @team:KhulnaSoft/logs-app @team:KhulnaSoft/logs-core
