...
Feature: Spans
  Search and aggregate your spans from your Khulnasoft platform over HTTP.
  ...
  @replay-only @skip-validation @team:KhulnaSoft/apm @with-pagination
