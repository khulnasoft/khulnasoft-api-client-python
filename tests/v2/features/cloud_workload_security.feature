...
Feature: Cloud Workload Security
  Workload activity security rules for generating events using the Khulnasoft
  security Agent. See the [Setting up CSM Workload Security page](https://do
  cs.khulnasoft.com/security/cloud_security_management/setup/csm_workload_sec
  ...
  @team:KhulnaSoft/k9-cloud-security-platform @team:KhulnaSoft/k9-cws-backend
  ...
  @skip @team:KhulnaSoft/k9-cloud-security-platform @team:KhulnaSoft/k9-cws-backend
