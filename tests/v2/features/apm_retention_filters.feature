...
Feature: APM Retention Filters
  ...
  filters](https://app.khulnasoft.com/apm/traces/retention-filters) for your
  organization. You need an API and application key with Admin rights to
  interact with this endpoint. See [retention filters](https://docs.khulnasofth
  ...
  @team:KhulnaSoft/apm-trace-intake
  ...
  @generated @skip @team:KhulnaSoft/apm-trace-intake
  ...
  @replay-only @team:KhulnaSoft/apm-trace-intake
