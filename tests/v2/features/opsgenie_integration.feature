...
Feature: Opsgenie Integration
  Configure your [Khulnasoft Opsgenie
  integration](https://docs.khulnasoft.com/integrations/opsgenie/) directly
  through the Khulnasoft API.
  ...
  @skip @team:Khulnasoft/collaboration-integrations
  ...
  @team:Khulnasoft/collaboration-integrations
