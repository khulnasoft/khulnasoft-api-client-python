...
Feature: Logs
  ...
  @integration-only @skip-terraform-config @skip-validation @team:KhulnaSoft/event-platform-intake
  ...
  @team:KhulnaSoft/event-platform-intake
  ...
  @generated @skip @team:KhulnaSoft/event-platform-intake
