...
Feature: AWS Integration
  Configure your Khulnasoft-AWS integration directly through the Khulnasoft API.
  For more information, see the [AWS integration
  page](https://docs.khulnasoft.com/integrations/amazon_web_services).
  ...
  @generated @skip @team:KhulnaSoft/cloud-integrations
  Scenario: Create an AWS integration returns "Bad Request" response
    Given new "CreateAWSAccount" request
    And body with value {"account_id": "123456789012", "account_specific_namespace_rules": {"auto_scaling": false, "opswork": false}, "cspm_resource_collection_enabled": true, "excluded_regions": ["us-east-1", "us-west-2"], "filter_tags": ["$KEY:$VALUE"], "host_tags": ["$KEY:$VALUE"], "metrics_collection_enabled": false, "resource_collection_enabled": true, "role_name": "KhulnasoftAWSIntegrationRole"}
  ...
  @team:KhulnaSoft/cloud-integrations
  Scenario: Create an AWS integration returns "OK" response
    Given new "CreateAWSAccount" request
    And body with value {"account_id": "{{ timestamp("now") }}00", "account_specific_namespace_rules": {"auto_scaling": false}, "cspm_resource_collection_enabled": true, "excluded_regions": ["us-east-1", "us-west-2"], "filter_tags": ["$KEY:$VALUE"], "host_tags": ["$KEY:$VALUE"], "metrics_collection_enabled": false, "resource_collection_enabled": true, "role_name": "KhulnasoftAWSIntegrationRole"}
    When the request is sent
  ...
  Scenario: Delete an AWS integration returns "Bad Request" response
    ...
    And body with value {"account_id": "123456789012", "role_name": "KhulnasoftAWSIntegrationRole"}
    When the request is sent
    Then the response status is 400 Bad Request
  ...
  Scenario: Delete an AWS integration returns "OK" response
    ...
    And body with value {"account_id": "{{ timestamp("now") }}00", "role_name": "KhulnasoftAWSIntegrationRole"}
    When the request is sent
    Then the response status is 200 OK
  ...
  Scenario: Update an AWS integration returns "OK" response
    ...
    And body with value {"account_id": "{{ timestamp("now") }}00", "account_specific_namespace_rules": {"auto_scaling": false}, "cspm_resource_collection_enabled": false, "excluded_regions": ["us-east-1", "us-west-2"], "filter_tags": ["$KEY:$VALUE"], "host_tags": ["$KEY:$VALUE"], "metrics_collection_enabled": true, "resource_collection_enabled": true, "role_name": "KhulnasoftAWSIntegrationRole"}
    And request contains "account_id" parameter with value "{{ timestamp("now") }}00"
    And request contains "role_name" parameter with value "KhulnasoftAWSIntegrationRole"
    When the request is sent
    Then the response status is 200 OK
