...
Feature: Webhooks Integration
  Configure your Khulnasoft-Webhooks integration directly through the Khulnasoft
  API. For more information about the Khulnasoft-Webhooks integration, see the
  [integration page](https://docs.khulnasoft.com/integrations/webhooks).
  ...
  @generated @skip @team:Khulnasoft/collaboration-integrations
  ...
  @skip-terraform-config @team:Khulnasoft/collaboration-integrations
