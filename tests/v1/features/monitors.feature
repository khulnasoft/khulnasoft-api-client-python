...
Feature: Monitors
  [Monitors](https://docs.khulnasoft.com/monitors) allow you to watch a
  ...
  Monitors](https://docs.khulnasoft.com/monitors/create/types/).
  ...
  @integration-only @team:KhulnaSoft/monitor-app
  ...
  @skip @team:KhulnaSoft/monitor-app
