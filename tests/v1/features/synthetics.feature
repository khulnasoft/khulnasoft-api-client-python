...
Feature: Synthetics
  Khulnasoft Synthetic Monitoring uses simulated user requests and browser
  ...
  flavors, [API
  tests](https://docs.khulnasoft.com/synthetics/api_tests/?tab=httptest) and
  ...
  documentation](https://docs.khulnasoft.com/synthetics/).
  ...
  @replay-only @skip-validation @team:KhulnaSoft/synthetics-app
  ...
  @generated @skip @team:KhulnaSoft/synthetics-app
  ...
  @skip @team:KhulnaSoft/synthetics-app
  ...
  @replay-only @team:KhulnaSoft/synthetics-app
  ...
  @replay-only @skip-validation @team:KhulnaSoft/synthetics-app @with-pagination
