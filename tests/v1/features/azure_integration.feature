...
Feature: Azure Integration
  Configure your Khulnasoft-Azure integration directly through the Khulnasoft API.
  For more information, see the [Khulnasoft-Azure integration
  page](https://docs.khulnasoft.com/integrations/azure).
  ...
  @generated @skip @team:KhulnaSoft/azure-integrations
  ...
  @team:KhulnaSoft/azure-integrations
