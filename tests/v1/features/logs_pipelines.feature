...
Feature: Logs Pipelines
  ...
  page](https://app.khulnasoft.com/logs/pipelines)   for a list of the
  ...
  documentation](https://docs.khulnasoft.com/logs/log_configuration/processor
  s/?tab=api#lookup-processor).  - For more information about Pipelines, see
  the   [pipeline documentation](https://docs.khulnasoft.com/logs/log_configu
  ...
  **Grok parsing rules may effect JSON output and require returned data to
  ...
  @generated @skip @team:KhulnaSoft/event-platform-experience
