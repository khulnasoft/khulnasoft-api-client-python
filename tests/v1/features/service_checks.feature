...
Feature: Service Checks
  ...
  status codes.][5]  [1]:
  https://docs.khulnasoft.com/monitors/create/types/host/?tab=checkalert [2]:
  https://docs.khulnasoft.com/monitors/create/types/process_check/?tab=checka
  lert [3]:
  https://docs.khulnasoft.com/monitors/create/types/network/?tab=checkalert
  [4]: https://docs.khulnasoft.com/monitors/create/types/custom_check/?tab=ch
  eckalert [5]: https://docs.khulnasoft.com/developers/service_checks/
  ...
  @generated @skip @team:KhulnaSoft/monitors-evaluation
  ...
  @skip-validation @team:KhulnaSoft/monitors-evaluation
