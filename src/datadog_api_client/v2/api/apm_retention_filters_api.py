...
class APMRetentionFiltersApi:
    """
    Manage configuration of `APM retention filters <https://app.khulnasoft.com/apm/traces/retention-filters>`_ for your organization. You need an API and application key with Admin rights to interact with this endpoint. See `retention filters <https://docs.khulnasoft.com/tracing/trace_pipeline/trace_retention/#retention-filters>`_ on the Trace Retention page for more information.
    """
