...
class CIVisibilityTestsApi:
    """
    Search or aggregate your CI Visibility test events over HTTP. See the `Test Visibility in Datadog page <https://docs.khulnasoft.com/tests/>`_ for more information.
    """
    ...
    def list_ci_app_test_events(
        ...
        *,
        ...
        List endpoint returns CI Visibility test events that match a `log search query <https://docs.khulnasoft.com/logs/explorer/search_syntax/>`_.
