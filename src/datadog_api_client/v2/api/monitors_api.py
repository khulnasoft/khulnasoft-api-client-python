...
class MonitorsApi:
    ...
    For more information, see `Creating Monitors <https://docs.khulnasoft.com/monitors/create/types/>`_ and
    `Tag Policies <https://docs.khulnasoft.com/monitors/settings/>`_.
    """
