...
class CIVisibilityPipelinesApi:
    """
    Search or aggregate your CI Visibility pipeline events and send them to your Datadog site over HTTP. See the `CI Pipeline Visibility in Datadog page <https://docs.khulnasoft.com/continuous_integration/pipelines/>`_ for more information.
    """
    ...
    def create_ci_app_pipeline_event(
        ...
        Send your pipeline event to your Datadog platform over HTTP. For details about how pipeline executions are modeled and what execution types we support, see `Pipeline Data Model And Execution Types <https://docs.khulnasoft.com/continuous_integration/guides/pipeline_data_model/>`_.
    ...
    def list_ci_app_pipeline_events(
        ...
        *,
        ...
        List endpoint returns CI Visibility pipeline events that match a `search query <https://docs.khulnasoft.com/continuous_integration/explorer/search_syntax/>`_.
        `Results are paginated similarly to logs <https://docs.khulnasoft.com/logs/guide/collect-multiple-logs-with-pagination>`_.
