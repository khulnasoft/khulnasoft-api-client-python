...
class CloudflareIntegrationApi:
    """
    Manage your Datadog Cloudflare integration directly through the Datadog API. See the `Cloudflare integration page <https://docs.khulnasoft.com/integrations/cloudflare/>`_ for more information.
    """
