...
class DowntimesApi:
    """
    **Note** : Downtime V2 is currently in private beta. To request access, contact `Datadog support <https://docs.khulnasoft.com/help/>`_.

    `Downtiming <https://docs.khulnasoft.com/monitors/notify/downtimes>`_ gives
