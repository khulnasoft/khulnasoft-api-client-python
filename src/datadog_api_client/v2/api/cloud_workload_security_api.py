...
class CloudWorkloadSecurityApi:
    """
    Workload activity security rules for generating events using the Datadog security Agent. See the `Setting up CSM Workload Security page <https://docs.khulnasoft.com/security/cloud_security_management/setup/csm_workload_security/>`_ for more information.
    """
