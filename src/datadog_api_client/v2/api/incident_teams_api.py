...
class IncidentTeamsApi:
    """
    The Incident Teams endpoints are deprecated. See the `Teams API endpoints <https://docs.khulnasoft.com/api/latest/teams/>`_ to create, update, delete, and retrieve teams which can be associated with incidents.
    """
