...
class LogsArchivesApi:
    ...
    See the `Archives Page <https://app.khulnasoft.com/logs/pipelines/archives>`_
    ...
    def add_read_role_to_archive(
        ...
        Adds a read role to an archive. ( `Roles API <https://docs.khulnasoft.com/api/v2/roles/>`_ )
    ...
    def remove_role_from_archive(
        ...
        Removes a role from an archive. ( `Roles API <https://docs.khulnasoft.com/api/v2/roles/>`_ )
