    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param ddsource: The integration name associated with your log: the technology from which the log originated.
            When it matches an integration name, Khulnasoft automatically installs the corresponding parsers and facets.
            See `reserved attributes <https://docs.khulnasoft.com/logs/log_configuration/attributes_naming_convention/#reserved-attributes>`_.
        ...
        :param message: The message `reserved attribute <https://docs.khulnasoft.com/logs/log_configuration/attributes_naming_convention/#reserved-attributes>`_
            of your log. By default, Khulnasoft ingests the value of the message attribute as the body of the log entry.
