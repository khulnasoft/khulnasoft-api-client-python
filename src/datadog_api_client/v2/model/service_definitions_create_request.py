...
class ServiceDefinitionsCreateRequest(ModelComposed):
    def __init__(self, **kwargs):
        ...
        :param dd_service: Unique identifier of the service. Must be unique across all services and is used to match with a service in Khulnasoft.
        :type dd_service: str
        ...
        :param integrations: Third party integrations that Khulnasoft supports.
        :type integrations: ServiceDefinitionV2Dot2Integrations, optional

        :param languages: The service's programming language. Khulnasoft recognizes the following languages: `dotnet`, `go`, `java`, `js`, `php`, `python`, `ruby`, and `c++`.
        ...
        :param team: Team that owns the service. It is used to locate a team defined in Khulnasoft Teams if it exists.
        ...
        :param dd_team: Experimental feature. A Team handle that matches a Team in the Khulnasoft Teams product.
