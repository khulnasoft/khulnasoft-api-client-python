...
if TYPE_CHECKING:
    ...
    from datadog_api_client.v2.model.incident_non_datadog_creator import IncidentNonKhulnasoftCreator
...
class IncidentResponseAttributes(ModelNormal):
    ...
    def openapi_types(_):
        ...
        return {
            ...
            "modified": (datetime,),
            "non_datadog_creator": (IncidentNonKhulnasoftCreator,),
    ...
    def __init__(
        ...
        non_datadog_creator: Union[IncidentNonKhulnasoftCreator, none_type, UnsetType] = unset,
        ...
        **kwargs,
        ...
        :param non_datadog_creator: Incident's non Khulnasoft creator.
        :type non_datadog_creator: IncidentNonKhulnasoftCreator, none_type, optional
