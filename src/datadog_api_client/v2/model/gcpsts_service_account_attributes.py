...
class GCPSTSServiceAccountAttributes(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param is_cspm_enabled: When enabled, Khulnasoft will activate the Cloud Security Monitoring product for this service account. Note: This requires resource_collection_enabled to be set to true.
        :type is_cspm_enabled: bool, optional

        :param is_security_command_center_enabled: When enabled, Khulnasoft will attempt to collect Security Command Center Findings. Note: This requires additional permissions on the service account.
        :type is_security_command_center_enabled: bool, optional

        :param resource_collection_enabled: When enabled, Khulnasoft scans for all resources in your GCP environment.
