...
class DowntimeUpdateRequestAttributes(ModelNormal):
    @cached_property
    def openapi_types(_):
        from datadog_api_client.v2.model.downtime_monitor_identifier import DowntimeMonitorIdentifier
        from datadog_api_client.v2.model.downtime_notify_end_state_types import DowntimeNotifyEndStateTypes
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param display_timezone: The timezone in which to display the downtime's start and end times in Khulnasoft applications. This is not used
        ...
        :type schedule: DowntimeScheduleUpdateRequest, optional

        :param scope: The scope to which the downtime applies. Must follow the `common search syntax <https://docs.khulnasoft.com/logs/explorer/search_syntax/>`_.
