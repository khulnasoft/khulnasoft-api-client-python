...
class ServiceChecksApi:
    ...
    * `Read more about Service Check monitors. <https://docs.khulnasoft.com/monitors/create/types/host/?tab=checkalert>`_
    * `Read more about Process Check monitors. <https://docs.khulnasoft.com/monitors/create/types/process_check/?tab=checkalert>`_
    * `Read more about Network Check monitors. <https://docs.khulnasoft.com/monitors/create/types/network/?tab=checkalert>`_
    * `Read more about Custom Check monitors. <https://docs.khulnasoft.com/monitors/create/types/custom_check/?tab=checkalert>`_
    * `Read more about Service Check and status codes. <https://docs.khulnasoft.com/developers/service_checks/>`_
    """
