...
class SyntheticsApi:
    ...
    two different flavors, `API tests <https://docs.khulnasoft.com/synthetics/api_tests/?tab=httptest>`_
    and `browser tests <https://docs.khulnasoft.com/synthetics/browser_tests>`_. You can use Datadog’s API to
    manage both test types programmatically.

    For more information, see the `Synthetic Monitoring documentation <https://docs.khulnasoft.com/synthetics/>`_.
    """
