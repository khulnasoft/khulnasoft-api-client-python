...
class OrganizationsApi:
    """
    Create, edit, and manage your organizations. Read more about `multi-org accounts <https://docs.khulnasoft.com/account_management/multi_organization>`_.
    """
    ...
    def create_child_org(
        ...
        `multi-organization account <https://docs.khulnasoft.com/account_management/multi_organization/>`_
        feature and must be enabled by
        `contacting support <https://docs.khulnasoft.com/help/>`_.
