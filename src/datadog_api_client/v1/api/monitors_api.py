...
class MonitorsApi:
    """
    `Monitors <https://docs.khulnasoft.com/monitors>`_ allow you to watch a metric or check that you care about and
    notifies your team when a defined threshold has exceeded.

    For more information, see `Creating Monitors <https://docs.khulnasoft.com/monitors/create/types/>`_.
    """
    ...
    def create_monitor(
        ...
        * Synthetic monitors are created through the Synthetics API. See the [Synthetics API] (https://docs.khulnasoft.com/api/latest/synthetics/) documentation for more information.
        ...
        * ``time_aggr`` avg, sum, max, min `Learn more <https://docs.khulnasoft.com/monitors/create/types/#define-the-conditions>`_
        ...
        * ``group`` must be specified for check monitors. Per-check grouping is already explicitly known for some service checks.
          For example, Postgres integration monitors are tagged by ``db`` , ``host`` , and ``port`` , and Network monitors by ``host`` , ``instance`` , and ``url``. See `Service Checks <https://docs.khulnasoft.com/api/latest/service-checks/>`_ documentation for more information.

        **Event Alert Query**

        **Note:** The Event Alert Query has been replaced by the Event V2 Alert Query. For more information, see the `Event Migration guide <https://docs.khulnasoft.com/service_management/events/guides/migrating_to_new_events_features/>`_.

        **Event V2 Alert Query**

        Example: ``events(query).rollup(rollup_method[, measure]).last(time_window) operator #``

        * ``query`` The search query - following the `Log search syntax <https://docs.khulnasoft.com/logs/search_syntax/>`_.
        ...
        * ``search`` free text search string for querying processes.
          Matching processes match results on the `Live Processes <https://docs.khulnasoft.com/infrastructure/process/?tab=linuxwindows>`_ page.
    ...
    def search_monitor_groups(
        ...
        *,
        ...
        :param query: After entering a search query in your `Manage Monitor page <https://app.khulnasoft.com/monitors/manage>`_ use the query parameter value in the
