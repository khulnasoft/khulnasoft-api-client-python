...
class AuthenticationApi:
    ...
    **Note:** All Datadog API clients are configured by default to consume Datadog US site APIs.
    If you are on the Datadog EU site, set the environment variable ``KHULNASOFT_HOST`` to
    ``https://api.datadoghq.eu`` or override this value directly when creating your client.

    `Manage your account’s API and application keys <https://app.khulnasoft.com/organization-settings/>`_ in Datadog, and see the `API and Application Keys page <https://docs.khulnasoft.com/account_management/api-app-keys/>`_ in the documentation.
    """
