...
class UsageMeteringApi:
    ...
    Usage is only accessible for `parent-level organizations <https://docs.khulnasoft.com/account_management/multi_organization/>`_.
    ...
    **Note** : Usage data is delayed by up to 72 hours from when it was incurred.
    ...
    Learn more on the `usage details documentation <https://docs.khulnasoft.com/account_management/billing/usage_details/>`_.
    """
    ...
    def get_daily_custom_reports(
        ...
        **Note:** This endpoint will be fully deprecated on December 1, 2022.
        Refer to `Migrating from v1 to v2 of the Usage Attribution API <https://docs.khulnasoft.com/account_management/guide/usage-attribution-migration/>`_ for the associated migration guide.
    ...
    def get_incident_management(
        ...
        *,
        ...
        Get hourly usage for incident management.
        **Note:** hourly usage data for all products is now available in the `Get hourly usage by product family API <https://docs.khulnasoft.com/api/latest/usage-metering/#get-hourly-usage-by-product-family>`_. Refer to `Migrating from the V1 Hourly Usage APIs to V2 <https://docs.khulnasoft.com/account_management/guide/hourly-usage-migration/>`_ for the associated migration guide.
    ...
    def get_usage_fargate(
        ...
        *,
        ...
        Get hourly usage for `Fargate <https://docs.khulnasoft.com/integrations/ecs_fargate/>`_.
        **Note:** hourly usage data for all products is now available in the `Get hourly usage by product family API <https://docs.khulnasoft.com/api/latest/usage-metering/#get-hourly-usage-by-product-family>`_. Refer to `Migrating from the V1 Hourly Usage APIs to V2 <https://docs.khulnasoft.com/account_management/guide/hourly-usage-migration/>`_ for the associated migration guide.
    ...
    def get_usage_rum_sessions(
        ...
        *,
        ...
        Get hourly usage for `RUM <https://docs.khulnasoft.com/real_user_monitoring/>`_ Sessions.
        **Note:** hourly usage data for all products is now available in the `Get hourly usage by product family API <https://docs.khulnasoft.com/api/latest/usage-metering/#get-hourly-usage-by-product-family>`_. Refer to `Migrating from the V1 Hourly Usage APIs to V2 <https://docs.khulnasoft.com/account_management/guide/hourly-usage-migration/>`_ for the associated migration guide.
    ...
    def get_usage_rum_units(
        ...
        *,
        ...
        Get hourly usage for `RUM <https://docs.khulnasoft.com/real_user_monitoring/>`_ Units.
        **Note:** hourly usage data for all products is now available in the `Get hourly usage by product family API <https://docs.khulnasoft.com/api/latest/usage-metering/#get-hourly-usage-by-product-family>`_. Refer to `Migrating from the V1 Hourly Usage APIs to V2 <https://docs.khulnasoft.com/account_management/guide/hourly-usage-migration/>`_ for the associated migration guide.
    ...
    def get_usage_synthetics(
        ...
        *,
        ...
        Get hourly usage for `synthetics checks <https://docs.khulnasoft.com/synthetics/>`_.
        **Note:** hourly usage data for all products is now available in the `Get hourly usage by product family API <https://docs.khulnasoft.com/api/latest/usage-metering/#get-hourly-usage-by-product-family>`_. Refer to `Migrating from the V1 Hourly Usage APIs to V2 <https://docs.khulnasoft.com/account_management/guide/hourly-usage-migration/>`_ for the associated migration guide.
    ...
    def get_usage_synthetics_api(
        ...
        *,
        ...
        Get hourly usage for `synthetics API checks <https://docs.khulnasoft.com/synthetics/>`_.
        **Note:** hourly usage data for all products is now available in the `Get hourly usage by product family API <https://docs.khulnasoft.com/api/latest/usage-metering/#get-hourly-usage-by-product-family>`_. Refer to `Migrating from the V1 Hourly Usage APIs to V2 <https://docs.khulnasoft.com/account_management/guide/hourly-usage-migration/>`_ for the associated migration guide.
    ...
    def get_usage_timeseries(
        ...
        *,
        ...
        Get hourly usage for `custom metrics <https://docs.khulnasoft.com/developers/metrics/custom_metrics/>`_.
        **Note:** hourly usage data for all products is now available in the `Get hourly usage by product family API <https://docs.khulnasoft.com/api/latest/usage-metering/#get-hourly-usage-by-product-family>`_. Refer to `Migrating from the V1 Hourly Usage APIs to V2 <https://docs.khulnasoft.com/account_management/guide/hourly-usage-migration/>`_ for the associated migration guide.
    ...
    def get_usage_top_avg_metrics(
        ...
        *,
        ...
        Get all `custom metrics <https://docs.khulnasoft.com/developers/metrics/custom_metrics/>`_ by hourly average. Use the month parameter to get a month-to-date data resolution or use the day parameter to get a daily resolution. One of the two is required, and only one of the two is allowed.
