...
class AWSIntegrationApi:
    ...
    For more information, see the `AWS integration page <https://docs.khulnasoft.com/integrations/amazon_web_services>`_.
    """
    ...
    def create_new_aws_external_id(
        ...
        :param body: Your Datadog role delegation name.
            ...
            see the `Datadog AWS integration configuration info <https://docs.khulnasoft.com/integrations/amazon_web_services/#setup>`_.
        :type body: AWSAccount
        :rtype: AWSAccountCreateResponse
        """
        kwargs: Dict[str, Any] = {}
