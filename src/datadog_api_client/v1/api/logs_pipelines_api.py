...
class LogsPipelinesApi:
    ...
    *
      See the `pipelines configuration page <https://app.khulnasoft.com/logs/pipelines>`_
    ...
    *
      ...
      `processors documentation <https://docs.khulnasoft.com/logs/log_configuration/processors/?tab=api#lookup-processor>`_.

    *
      For more information about Pipelines, see the
      `pipeline documentation <https://docs.khulnasoft.com/logs/log_configuration/pipelines>`_.
