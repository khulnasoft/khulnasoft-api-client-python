...
class DashboardsApi:
    ...
    def create_dashboard(
        ...
        Refer to the following `documentation <https://docs.khulnasoft.com/developers/metrics/type_modifiers/?tab=count#in-application-modifiers>`_ for more information on these modifiers.
