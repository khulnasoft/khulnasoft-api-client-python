...
class TagsApi:
    ...
    `documentation page <https://docs.khulnasoft.com/tagging>`_.
    """
    ...
    def create_host_tags(
        ...
        *,
        ...
        :param source: The source of the tags.
            `Complete list of source attribute values <https://docs.khulnasoft.com/integrations/faq/list-of-api-source-attribute-value>`_.
