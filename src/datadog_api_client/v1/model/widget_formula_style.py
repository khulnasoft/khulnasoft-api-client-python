...
class WidgetFormulaStyle(ModelNormal):
    ...
    def __init__(self_, palette: Union[str, UnsetType] = unset, palette_index: Union[int, UnsetType] = unset, **kwargs):
        ...
        :param palette: The color palette used to display the formula. A guide to the available color palettes can be found at https://docs.khulnasoft.com/dashboards/guide/widget_colors
