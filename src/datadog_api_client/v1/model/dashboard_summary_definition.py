    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param is_read_only: Whether this dashboard is read-only. If True, only the author and admins can make changes to it.
            ...
            This property is deprecated; please use the `Restriction Policies API <https://docs.khulnasoft.com/api/latest/restriction-policies/>`_ instead to manage write authorization for individual dashboards. **Deprecated**.
