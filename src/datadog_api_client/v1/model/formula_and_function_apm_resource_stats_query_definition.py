...
class FormulaAndFunctionApmResourceStatsQueryDefinition(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param primary_tag_name: Name of the second primary tag used within APM. Required when ``primary_tag_value`` is specified. See https://docs.khulnasoft.com/tracing/guide/setting_primary_tags_to_scope/#add-a-second-primary-tag-in-datadog
