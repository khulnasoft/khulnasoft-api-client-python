...
class LogQueryDefinition(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param index: A coma separated-list of index names. Use "*" query all indexes at once. `Multiple Indexes <https://docs.khulnasoft.com/logs/indexes/#multiple-indexes>`_
