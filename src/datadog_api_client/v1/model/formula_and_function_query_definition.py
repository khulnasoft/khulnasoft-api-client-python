...
class FormulaAndFunctionQueryDefinition(ModelComposed):
    def __init__(self, **kwargs):
        ...
        :param primary_tag_name: The name of the second primary tag used within APM; required when `primary_tag_value` is specified. See https://docs.khulnasoft.com/tracing/guide/setting_primary_tags_to_scope/#add-a-second-primary-tag-in-datadog.
