    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param graph_def: A JSON document defining the graph. ``graph_def`` can be used instead of ``metric_query``.
            The JSON document uses the `grammar defined here <https://docs.khulnasoft.com/graphing/graphing_json/#grammar>`_
        ...
        :param snapshot_url: URL of your `graph snapshot <https://docs.khulnasoft.com/metrics/explorer/#snapshot>`_.
