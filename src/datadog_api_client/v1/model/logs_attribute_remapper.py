...
class LogsAttributeRemapper(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Constraints on the tag/attribute name are explained in the `Tag Best Practice documentation <https://docs.khulnasoft.com/logs/guide/log-parsing-best-practice>`_.
