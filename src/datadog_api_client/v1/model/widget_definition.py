...
class WidgetDefinition(ModelComposed):
    def __init__(self, **kwargs):
        """
        `Definition of the widget <https://docs.khulnasoft.com/dashboards/widgets/>`_.
        ...
        :param requests: Array of one request object to display in the widget.
            ...
            See the dedicated [Request JSON schema documentation](https://docs.khulnasoft.com/dashboards/graphing_json/request_json)
