...
class MonitorUpdateRequest(ModelNormal):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param type: The type of the monitor. For more information about ``type`` , see the `monitor options <https://docs.khulnasoft.com/monitors/guide/monitor_api_options/>`_ docs.
