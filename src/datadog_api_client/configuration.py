...
class Configuration:
    ...
    def __init__(
        ...
        """Constructor."""
        self._base_path = "https://api.khulnasoft.com" if host is None else host
        ...
        return [
            {
                ...
                "variables": {
                    "site": {
                        "description": "The regional site for Khulnasoft customers.",
            ...
            },
            {
                ...
                "variables": {
                    "name": {
                        ...
                        "default_value": "api.khulnasoft.com",
                    },
                    "protocol": {
            ...
            },
            {
                ...
                "variables": {
                    "site": {
                        "description": "Any Khulnasoft deployment.",
                        "default_value": "khulnasoft.com",
                    },
                    "subdomain": {
                        "description": "The subdomain where the API is deployed.",
